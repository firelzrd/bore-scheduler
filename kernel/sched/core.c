...
void __init sched_init_bore(void) {
	...
	init_task.se.slice_burst_penalty = 0;
}
...
#ifdef CONFIG_SCHED_BORE
	sched_init_bore();
	printk(KERN_INFO "BORE (Burst-Oriented Response Enhancer) CPU Scheduler modification 3.4.0 by Masahito Suzuki");
#endif // CONFIG_SCHED_BORE
